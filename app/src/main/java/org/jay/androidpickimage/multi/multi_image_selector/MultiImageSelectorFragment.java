package org.jay.androidpickimage.multi.multi_image_selector;
...
import org.jay.androidpickimage.multi.multi_image_selector.adapter.FolderAdapter;
import org.jay.androidpickimage.multi.multi_image_selector.adapter.ImageGridAdapter;
import org.jay.androidpickimage.multi.multi_image_selector.bean.Folder;
import org.jay.androidpickimage.multi.multi_image_selector.bean.Image;
import org.jay.androidpickimage.multi.multi_image_selector.utils.FileUtils;
import org.jay.androidpickimage.multi.multi_image_selector.utils.ScreenUtils;
        ...
        if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    intent.putExtra(MediaStore.EXTRA_OUTPUT, contentUri); //Uri.fromFile(tempFile)
